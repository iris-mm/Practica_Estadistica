...
Se inicializará al comenzar el ánalisis univariante.
...
Vamos a proceder a calcular los valores de la media y la mediana de las siguientes variables:
...
Este grafíco representara una representación de la mediana, rango entre cuartiles y valores atípicos del peso del vehículo.
```{r}
...
Gracias a estos grafícos, podemos visualizar más claramente los datos del apartado anterior en forma de gráfico.
