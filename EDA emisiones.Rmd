...
Vamos a proceder a calcular los valores de la media y la mediana de las siguientes variables:
  ...
  - **La media** representa el promedio de los valores de la columna emissions_max_gCO2_km, conocer este valor nos hace más fácil hacernos una idea de cuanta emision hay aproximadamente por cada kilómetro.
